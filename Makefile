...
FILE_DA_CONSEGNARE=Makefile chatty.c message.h ops.h stats.h config.h \
		   DATA/chatty.conf1 DATA/chatty.conf2 connections.h DATA/script.sh \
		   AlgoCoda.c AlgoCoda.h connections.c Group.c Group.h \
		   hash.c hash.h history.c history.h libchatty.a listener.c
# inserire il nome del tarball: es. NinoBixio
TARNAME=AlessioRusso
...
chatty: chatty.o hash.o AlgoCoda.o connections.o message.h history.o  libchatty.a $(INCLUDE_FILES)
